...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public static final String AUTHORITY = "com.avatarins.avatarclaiminspection";
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        row.add(Root.COLUMN_ICON, R.drawable.avatar_logo);
    ...
    public String createDocument(final String parentDocumentId, final String mimeType,
        ...
        try {
            ...
            ViewUtils.print(LocalStorageProvider.class.getSimpleName(), "Error creating new file " + newFile);
        }
        return null;
    }
